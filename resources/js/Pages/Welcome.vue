        ...
        <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
            <div class="flex flex-row items-center justify-between py-6">
                <div class="relative md:mt-8">
                    <a href="#" class="text-lg relative z-50 font-bold tracking-widest text-gray-900 rounded-lg focus:outline-none focus:shadow-outline">SIMRS CINTA DAMAI</a>
		...
		<div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
			...
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				<h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-5xl font-bold leading-tight text-darken">
					<span class="text-yellow-500">SIMRS</span> CINTA DAMAI
				</h1>
				<p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-2xl mb-8">Sebut saja kami pecinta damai, hingga terwujudnya aplikasi SIMRS ini</p>
	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
		...
		<div class="sm:flex items-center sm:space-x-8 mt-36">
			...
			<div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
				...
				<button class="bg-white w-14 h-14 rounded-full flex items-center justify-center absolute top-1/2 left-1/2 transform 
				-translate-x-1/2 -translate-y-1/2 focus:outline-none  transition hover:scale-110 duration-300 ease-in-out z-50">
	...
	<footer class="mt-32" style="background-color: rgba(37, 38, 65, 1);">
		<div class="max-w-lg mx-auto">
			...
			<div class="text-center text-white">
				<p class="my-3 text-gray-400 text-sm">&copy; 2024 SIMRS CINTA DAMAI </p>
				<div class="py-3 tracking-wide">
					<!-- <p>Code By <span class="font-semibold">Tim Ganteng</span></p>
					<p>OFFICIAL <span class="font-semibold">SIMRS CINTA DAMAI</span></p> -->
				</div>
			</div>
		</div>
	</footer>
